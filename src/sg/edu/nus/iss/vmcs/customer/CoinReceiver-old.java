...
//		MoneyStore cashStore=(MoneyStore)txCtrl.getMainController().getStoreController().getStore(Store.COIN);
//		Money coin = cashStore.findMoney(new CoinAttribute(weight));
//		if(coin==null){
