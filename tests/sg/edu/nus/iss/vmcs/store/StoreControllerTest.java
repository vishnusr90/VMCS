...
//	}
	...
	public void testgetItems() throws Exception {
		...
		// Act getItems
		StoreIterator strItr = storeController.getStoreIterator(Store.COIN);
		strItr.first();
		while (strItr.hasNext()) {
			CoinStoreItem cashStoreItem = (CoinStoreItem) strItr.currentItem();
			strItr.next();
			// Assert
		...
		// Act getItems
		strItr = storeController.getStoreIterator(Store.DRINK);
		strItr.first();
		while (strItr.hasNext()){
			DrinksStoreItem drinksStoreItem = (DrinksStoreItem) strItr.currentItem();
			// Assert
	...
	public void testgetItem() throws Exception {
		...
		for (int i = 0; i < storeSize; i++) {
			// Act getItem
			CoinStoreItem cashStoreItem = (CoinStoreItem) storeController.getStoreItem(Store.COIN, i);
			// Assert
			assertNotNull(cashStoreItem);
		}
		DrinksStore drinksStore = (DrinksStore) storeController.getStore(Store.DRINK);
